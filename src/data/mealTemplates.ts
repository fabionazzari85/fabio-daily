...
export const homeWorkoutMealTemplates: MealTemplate[] = [
  ...
  },
  {
    ...
    description: "Pollo o tacchino cotto 170 g + riso basmati 55 g da crudo (circa 140-165 g cotto) + zucchine/carote + 1 cucchiaino olio EVO.",
  ...
  },
  {
    ...
    description: "2-3 gallette senza glutine + tonno naturale sgocciolato 80-100 g.",
  ...
  },
  {
    ...
    description: "Salmone 150 g + patate 250-300 g peso crudo + broccoli o verdure cotte. Grassi misurati.",
    estimatedMacros: { kcal: 550, proteinG: 43, carbsG: 48, fatG: 20 },
    alternatives: ["Pesce bianco + patate 250-300 g peso crudo + verdure", "Carne magra + riso 60-70 g da crudo + verdure", "Uova + verdure + pane GF pesato"],
...
export const walkRunMealTemplates: MealTemplate[] = [
  ...
  },
  {
    ...
    description: "Riso/quinoa/grano saraceno 50-60 g da crudo + proteina 150-180 g + verdure cotte + 1 cucchiaino olio EVO.",
  ...
  },
  {
    ...
    description: "Pasta senza glutine 60-70 g da crudo + ragu magro, oppure pesce + patate 250-300 g peso crudo.",
    estimatedMacros: { kcal: 560, proteinG: 45, carbsG: 60, fatG: 16 },
    alternatives: ["Pesce + patate 250-300 g peso crudo + verdure", "Risotto semplice con riso 60-70 g da crudo + proteina", "Carne magra + riso 60-70 g da crudo + verdure"],
...
export const recoveryMealTemplates: MealTemplate[] = [
  ...
  },
  {
    ...
    description: "Proteina 160-180 g + riso/quinoa/grano saraceno 40-50 g da crudo oppure patate 200-250 g peso crudo + verdure cotte.",
  ...
  },
  {
    ...
    description: "Pesce/carne/uova + verdure cotte + patate 200-250 g peso crudo oppure pasta/riso 50-60 g da crudo.",
    estimatedMacros: { kcal: 500, proteinG: 48, carbsG: 35, fatG: 16 },
    alternatives: ["Cena freezer semplice", "Pesce + verdure + patate 200-250 g peso crudo", "Uova + verdure + pane GF"],
...
export const travelCarMealTemplates: MealTemplate[] = [
  ...
  },
  {
    ...
    description: "Bowl freezer già porzionata, pratica da trasporto.",
  ...
  },
  {
    ...
    description: "Pesce, tagliata, risotto, poke/bowl GF o pasta GF con proteina.",
...
export const travelFarMealTemplates: MealTemplate[] = [
  ...
  },
  {
    ...
    description: "Bar, ristorante o supermercato: proteine prioritarie e carboidrato semplice senza glutine.",
...
export const sundayFreeMealTemplates: MealTemplate[] = [
  ...
  },
  {
    ...
    description: "Pesce/carne/uova + verdure cotte, pochi grassi e porzione piccola.",
